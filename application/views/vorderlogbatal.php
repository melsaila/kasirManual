...
$v = new Template();
$v->head();?>
<script type="text/javascript" src="<?php echo base_url('statics/js/orderlogbatal_25092014A.min.js'); ?>"></script>
<?php $v->main(); ?>
<table id="gorderlogbatal" class="easyui-datagrid" toolbar="#bar"></table>
...
$(function() {
    jOrderlogbatal.init("<?php echo $taxixkey; ?>");
});
</script>
<?php
$v->foot();
