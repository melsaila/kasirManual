...
$v = new Template();
$v->head();?>
<script type="text/javascript" src="<?php echo base_url('statics/js/taxireq_08072014a.min.js'); ?>"></script>
<?php $v->main(); ?>
<table id="gtaxireq" class="easyui-datagrid" toolbar="#bar"></table>
...
$(function() {
    jTxireq.init("<?php echo $taxixkey; ?>");
    jTxireq.grid();
});
</script>
<?php
