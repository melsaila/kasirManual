...
/*        min-height: 202px;
    ...
    #map_canvas div.gmnoprint[title^="Nama:"] {
...
function initialize() {
    ...
    $.get('<?php echo base_url("taximapsorderpending/taxis")?>', function(rsp) {
    ...
    $.get('<?php echo base_url("taximapsorderpending/getLatLongkonsumen")?>', function(rsp) {
        var ptaxis = $.parseJSON(rsp);
        var locations = [];
        var infoWindowContent = [];
        var jt = 0;
