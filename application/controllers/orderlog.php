...
class Orderlog extends MY_Controller{
    public function index()
    {
        $d['taxixkey'] = 'keys';
        $this->load->view('vorderlog',$d);
    }
    public function selects()
    {
        ...
        $sortby = $this->input->post('sort') !='' ? $this->input->post('sort',TRUE) : 'time_req';
        ...
        echo json_encode(array('total' => $drow['total'], 'rows' => $temp));*/
        echo json_encode($this->Mlogorder->area_read_allOrder($page, $rows, $sortby, $orderby, $searchby, $keyword));
    }
