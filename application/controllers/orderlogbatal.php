...
class Orderlogbatal extends MY_Controller{
    public function index()
    {
        $d['taxixkey'] = 'keys';
        $this->load->view('vorderlogbatal',$d);
    }
    public function selects()
    {
        ...
        $sortby = $this->input->post('sort') !='' ? $this->input->post('sort',TRUE) : 'id_log_trx';
        ...
        echo json_encode($this->Mlogorder->area_read($page, $rows, $sortby, $orderby, $searchby, $keyword,'R10'));
