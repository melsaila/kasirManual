"use strict";
var jOrderlogsukses = (function() {
    var hd = "",
        grid = '#gorderlogsukses';
    ...
    return {
        ...
        searchgrid : function () {
            dosearch("terminalsearch", "terminalkeyword", "gorderlogsukses","0");
        },
        grid: function() {
            $(grid).datagrid({
                url: rd().site_url("orderlogsukses/selects"),
                nowrap: true,
                singleSelect: true,
                rownumbers: true,
                fit: true,
...
$(function () {
    jOrderlogsukses.init('keys');
    jOrderlogsukses.grid();
    jOrderlogsukses.searchgrid()
});
